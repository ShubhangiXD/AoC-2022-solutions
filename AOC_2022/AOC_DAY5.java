...
public class AOC_DAY5 {
    public static void main(String[] args) throws IOException {
        final File src = new File("AOC_DAY5_src.txt");
        final List<String> fileContent = Files.readAllLines(src.toPath(), UTF_8);

        System.out.println(puzzle1(fileContent));
        System.out.println(puzzle2(fileContent));
    }

    private static String puzzle1(List<String> lines) {
    ...
    private static String puzzle2(List<String> lines) {
        final List<List<String>> col = new ArrayList<>();
